...
export function TreasureHuntCompletePage() {
    ...
    <main className="pt-24 pb-20 px-4 min-h-screen bg-gradient-to-br from-amber-50 to-amber-100">
      ...
      >
        <div className="grid grid-cols-2 gap-3">
          <button
            onClick={handleShare}
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-amber-700 text-white py-4 rounded-xl font-medium hover:from-amber-700 hover:to-amber-800 transition-all shadow-lg"
          >
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 py-4 rounded-xl font-medium transition-all shadow-lg ${
              copied 
